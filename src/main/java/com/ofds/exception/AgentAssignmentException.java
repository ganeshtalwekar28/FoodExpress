...
/**
 * Custom exception for business rule violations during order assignment (e.g.,
 * order not PLACED, agent not AVAILABLE).
 * Spring will automatically map this to an HTTP 400 Bad Request response.
 */
